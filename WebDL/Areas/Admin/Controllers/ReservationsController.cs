...
namespace WebDL.Areas.Admin.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FullName,Email,StartDate,EndDate,Destination,Participants")] Reservation reservation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FullName,Email,StartDate,EndDate,Destination,Participants")] Reservation reservation)
        {
            if (ModelState.IsValid)
            {
